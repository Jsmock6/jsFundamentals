...
/* NULL
    - null is an empty value. Think of it like a container: nothing is in it, but it still exists as a space to fill
 */
 ...
 */
 ...
 /*
    ...
    - Null is an empty box on purpose, Undefined is a box that hasnt been created yet
 */

 /*
    NUMBERS
        -numbers are literall just numbers. Don't need anything special to write them
 */
...
let firstName = 'James';
let lastName = 'Smock';
let houseNumber = 8623;
let street = 'Lighthorse Drive';
...
/*
    STRING:PROPERTIES
        ...
        -strings have properties that are associated specifically with strings
 */
