/*
    -javascript is interpreted line by line (top to bottom), and performs 2 passes of our code
        -the first pass of the code recognizes where we have declared variables and stores them in memory
